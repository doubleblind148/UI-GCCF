...
BASE_KP = "valid_top_k_"
PROJECTS = ["lastfm_dat", "Amaz_dat", "gowalla_dat"]
METRICS = ["Recall", "NDCG"]
CUTOFFS = [5, 20]

if __name__ == "__main__":
    for p in PROJECTS:
        setup_plot(241, fig_ratio=0.69, style_sheet="ablation_topk")
        api = wandb.Api()
        ...
        for m in METRICS:
            for c in CUTOFFS:
                ...
                colors = {
                    "valid_top_k": "darkblue",
                    "NDCG@20": "orange",
                    "Recall@5": "darkblue",
                    "NDCG@5": "orange",
                }

                sorter = ["5", "15", "30", "50", "100", "250"]
